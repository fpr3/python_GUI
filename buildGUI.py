...
Modified to adapt to tkinter documentation
https://docs.python.org/3/library/tkinter.html
Section 25.1.2.2 A Simple Hello World Program
...
class Adder(ttk.Frame):
    ...
    def init_gui(self):
        ...
        self.quit.grid(column=0, row=30, columnspan=4)

 
if __name__ == '__main__':
    root = tkinter.Tk()
    app = Adder(master=root)
    app.mainloop()
